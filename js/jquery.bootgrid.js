    ...
    */
            ...
            item = $(tpl.paginationItem.resolve(values))
                .on("click" + namespace, getCssSelector(css.paginationButton), function (e)
                {
                    ...
                    if (!parent.hasClass("active") && !parent.hasClass("disabled"))
                    {
                        ...
                        var command = $this.attr("data-command").substr(1);
                ...
                var item = $(tpl.actionDropDownItem.resolve(getParams.call(that,
                    { text: getText(value), uri: "#" + value })))
                        ...
                        .on("click" + namespace, menuItemSelector, function (e)
                        {
                            ...
                            var $this = $(this),
                                newRowCount = +$this.attr("data-command").substr(1);
                            if (newRowCount !== that.rowCount)
                            {
                                ...
                                {
                                    var $item = $(this),
                                        currentRowCount = +$item.find(menuItemSelector).attr("data-command").substr(1);
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            actionDropDownItem: "<li><a href=\"javascript:void(0);\" data-command=\"{{ctx.uri}}\" class=\"{{css.dropDownItem}} {{css.dropDownItemButton}}\">{{ctx.text}}</a></li>",
            ...
            paginationItem: "<li class=\"{{ctx.css}}\"><a href=\"javascript:void(0);\" data-command=\"{{ctx.uri}}\" class=\"{{css.paginationButton}}\">{{ctx.text}}</a></li>",
