...
<div data-ng-repeat="project in projects | orderBy: random" class="cp_pl">
 <div data-project-id="{{project.ProjectId}}"
      class="cp_pl_project"
  ...
  <div data-ng-class="{'cp_pl_invisible': !project.Visible}">
   ...
   <div class="cp_pl_other cp_pl_edit">
    <a href="#Project/Edit/{{project.ProjectId}}"
       data-ng-if="security.moderator == true || project.CreatedByUserID == @Dnn.User.UserID">@Html.GetLocalizedString("Edit")</a>
      </div>
     </div>
    </div>
   </div>
